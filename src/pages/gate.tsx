...
const INIT_TX =
  "3vK8oDvD3Q7ZMwgLidUPzkjfWM1TBszd55nX2r76Kv3DiN4tuYBFxNqgGrz9wgsV53uJo54kS661Co8YJ8Mxe8EY"
...
const HOW_IT_WORKS = [
  {
    n: "01",
    title: "Lock SOL",
    desc: "Set a deadline, stake SOL as collateral on your commitment.",
  },
  {
    n: "02",
    title: "Build",
    desc: "Ship the feature, write the code — on your schedule.",
  },
  {
    n: "03",
    title: "Oracle verifies",
    desc: "Ed25519 signature proves delivery on-chain in under 60 seconds.",
  },
  {
    n: "04",
    title: "Collect or get slashed",
    desc: "Deliver: get your stake back. Miss the deadline: stake is slashed.",
  },
]
...
function GatePage() {
  ...
  useEffect(() => {
    apiFetch("/waitlist/count")
      .then((r) => (r.ok ? r.json() : null))
      .then((data) => {
        if (data?.count != null) setWaitlistCount(data.count)
      })
      .catch(() => {})
  }, [])
  ...
  return (
    <main style={{ background: "var(--bg-primary)", minHeight: "100vh" }}>
      ...
      <section className="mx-auto max-w-[var(--container-max-width)] px-4 pt-20 pb-16 text-center">
        ...
        >
          SHIPSTAKE is live on Solana mainnet. Private beta &mdash; request
          access below.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-[var(--container-max-width)] px-4 pb-16">
        ...
        >
          ...
          <p
            ...
            style={{ color: "var(--muted-foreground)" }}
          >
            Oracle resolution &lt; 60s &nbsp;·&nbsp; Flat 2% settlement fee
      ...
      <section className="mx-auto max-w-[var(--container-max-width)] px-4 pb-24">
        ...
        >
          ...
          >
            We&rsquo;re onboarding builders one by one. Early access gets priority
            when we go public.
          </p>
