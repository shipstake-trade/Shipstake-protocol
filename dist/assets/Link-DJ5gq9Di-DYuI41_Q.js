import{j as d}from"./router-CbKEWjiJ.js";import{aV as c}from"./wallet-DYCjDBOf.js";let l=c.a`
  && {
...
`;const u=({size:r="md",variant:e="navigation",disabled:n=!1,as:a,children:t,onClick:o,...s})=>d.jsx(l,{as:a,$size:r,$variant:e,$disabled:n,onClick:i=>{n?i.preventDefault():o==null||o(i)},...s,children:t});export{u as n};
